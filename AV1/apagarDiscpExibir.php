...
<html lang="en" dir="ltr">
  ...
  <body>
    ...
    <div class="col-sm-6 offset-3">
      ...
      <table class='table table-bordered table-striped'>
        ...
        if ($result->num_rows > 0){
          ...
          echo "<script>alert('ID não encontrado'); location= 'listarTodasDisciplinas.php';</script>";
    ...
    <a class="btn btn-primary row-md-12 offset-5" href="apagarDiscp.php?idAux=<?php echo $idTemp?>">Apagar</a>
